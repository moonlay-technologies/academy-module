...
var validateProject = require('academy-models').validator.master.project;
var instanceManager = null;
require("should");

function getData() {
    var Project = require('academy-models').master.Project;
...
before('#00. connect db', function (done) {
    helper.getDb()
        .then(db => {
            instanceManager = new ProjectManager(db, {
                username: 'unit-test'
            });
            done();
        })
